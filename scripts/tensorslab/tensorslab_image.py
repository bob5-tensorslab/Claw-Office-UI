...
def generate_image(
    ...
    else:  # seedreamv5 (default),暂未上线，先使用seedream45代替
        endpoint = f"{API_BASE_URL}/v1/images/seedreamv45"
...
Examples:
  ...
  python tensorslab_image.py "a sunset over mountains" --model seedreamv45 --resolution 16:9
    ...
    parser.add_argument("--model", "-m", choices=["seedreamv4", "seedreamv45", "zimage", "seedreamv5"],
                       default="seedreamv5", help="Model to use (default: seedreamv4)")
